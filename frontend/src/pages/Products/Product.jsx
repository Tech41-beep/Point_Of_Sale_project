...
function Products() {
  ...
  // useEffect: use for fetching products from the API
  useEffect(() => {
  ...
  return (
    <div className="product-page rounded-xl bg-white p-6 shadow-sm">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-800">Products</h1>
        <Link className="primary-button" to="/products/add">
          + Add Product
        </Link>
      </div>
      {/* search */}
      ...
      <div className="mt-6 overflow-x-auto">
        ...
        <table className="w-full min-w-[650px] border-collapse text-left">
          ...
          <tbody className="text-sm text-gray-700">
            ...
            {/* loading and no products found messages */}
        ...
        {!loading && totalItems > 0 && (
          <div className="mt-4 flex flex-col items-center justify-between gap-3 border-t border-gray-200 pt-4 sm:flex-row">
            <span className="text-sm text-gray-500">
              Showing {(page - 1) * 9 + 1}–{Math.min(page * 9, totalItems)} of{" "}
              {totalItems}
            </span>
            <div className="flex items-center gap-2">
              <button
